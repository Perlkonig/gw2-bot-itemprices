...
module.exports = {
	...
	execute(message, args, db) {
        ...
        .then ((data) => {
            ...
            const medBuy = Math.round(ss.median(pruned.buy) * 10000) / 10000;
            const avgBuy = Math.round(ss.mean(pruned.buy) * 10000) / 10000;
            ...
            const medSell = Math.round(ss.median(pruned.sell) * 10000) / 10000;
            const avgSell = Math.round(ss.mean(pruned.sell) * 10000) / 10000;
